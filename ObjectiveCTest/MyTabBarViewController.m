...
- (void)initViewControllers{
    ...
    UIImage *imageOneSelected = [UIImage imageNamed:@"home_25#green"];
    //[[UIImage imageNamed:@"home_25#green"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    
    UIImage *imageTwo = [UIImage imageNamed:@"mine_25#70"];
    UIImage *imageTwoSelected = [UIImage imageNamed:@"mine_25#green"];
    //[[UIImage imageNamed:@"mine_25#green"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
