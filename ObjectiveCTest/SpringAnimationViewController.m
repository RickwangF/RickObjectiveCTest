...
-(void) animationBtnClicked:(UIButton*)sender{
    [UIView animateWithDuration:3.0 delay:0 usingSpringWithDamping:0.4 initialSpringVelocity:0.33 options:UIViewAnimationOptionCurveEaseOut | UIViewAnimationOptionRepeat animations:^{
        self.containerView.frame = CGRectMake(self.oriContainerX, self.oriContainerY - 200, 50, 50);
